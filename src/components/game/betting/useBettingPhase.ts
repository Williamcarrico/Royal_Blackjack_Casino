...
/**
 * Hook focused on UI betting phase functionality
 */
...
/**
 * Hook for managing the betting phase UI
 */
export const useBettingPhase = (
    ...
    // Get core betting functionality
    const betting = useBetting();

    // UI state for side bets
...
export default useBettingPhase;