    ...
    return (
        ...
        >
            ...
            <motion.div variants={itemVariants} className="grid grid-cols-2 gap-3">
                <Card className="bg-gradient-to-br from-amber-900/40 to-black/40 border border-amber-800/40 shadow-lg overflow-hidden">
                ...
                <Card className="bg-gradient-to-br from-emerald-900/40 to-black/40 border border-emerald-800/40 shadow-lg overflow-hidden">
                    <CardContent className="p-4 relative">
            ...
            <motion.div variants={itemVariants} className="mb-2">
                ...
                <div className="relative h-8 bg-black/30 rounded-lg overflow-hidden border border-amber-900/40">
                    <motion.div
                ...
                <div className="flex justify-between text-xs text-amber-400/70 mt-1 px-1">
                    <span>Wins</span>
            ...
            <motion.div variants={itemVariants} className="space-y-4">
                ...
                <div className="space-y-3 p-4 rounded-xl border border-amber-900/40 bg-black/30 backdrop-blur-sm">
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="flex items-center">
                                <ClockIcon className="w-4 h-4 text-amber-400 mr-2" />
