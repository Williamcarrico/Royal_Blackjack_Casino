...
export const policySections: PolicySection[] = [
	{
		...
		content: [
			"Welcome to DMS Casino Gaming's Privacy Policy. This comprehensive document outlines our commitment to protecting your personal information and data rights while using our platform.",
	...
	},
	{
		...
		lastUpdated: '2025-01-15',
		content: [
			'Privacy Team: Our dedicated privacy office is available to address your concerns and can be reached at privacy@dmscasinogaming.com.',
			'Data Requests: To submit a data access, correction, or deletion request, please use our secure data request form in your account settings or email dpo@dmscasinogaming.com.',
			...
			'Data Protection Officer: Our DPO can be contacted directly at dpo@dmscasinogaming.com for matters relating to data protection laws and regulations.',
			'Executive Escalation: For urgent or significant privacy matters, you may contact our CEO directly at ceo@dmscasinogaming.com.',
			'Regulatory Inquiries: For legal and regulatory matters, please direct your correspondence to legal@dmscasinogaming.com.',
			'Physical Address: DMS Casino Gaming, 123 Casino Boulevard, Suite 500, Las Vegas, NV 89109, USA.',
