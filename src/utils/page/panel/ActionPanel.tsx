    ...
    return (
        ...
        >
            ...
            >
                ...
                <span className="absolute inset-0 transition-opacity duration-300 opacity-0 bg-gradient-to-br from-emerald-500 to-emerald-700 group-hover:opacity-100 rounded-xl"></span>
            </motion.button>
            ...
            >
                ...
                <span className="absolute inset-0 transition-opacity duration-300 opacity-0 bg-gradient-to-br from-rose-500 to-rose-700 group-hover:opacity-100 rounded-xl"></span>
            </motion.button>
            ...
            {canDouble && (
                ...
                >
                    ...
                    <span className="absolute inset-0 transition-opacity duration-300 opacity-0 bg-gradient-to-br from-indigo-500 to-indigo-700 group-hover:opacity-100 rounded-xl"></span>
                </motion.button>
            )}
            ...
            {canSplit && (
                ...
                >
                    ...
                    <span className="absolute inset-0 transition-opacity duration-300 opacity-0 bg-gradient-to-br from-amber-500 to-amber-700 group-hover:opacity-100 rounded-xl"></span>
                </motion.button>
            )}
            ...
            {canSurrender && (
                ...
                >
                    ...
                    <span className="absolute inset-0 transition-opacity duration-300 opacity-0 bg-gradient-to-br from-slate-500 to-slate-700 group-hover:opacity-100 rounded-xl"></span>
                </motion.button>
            )}
        </motion.div>
    );
